...
public class GetEmployee extends TestBase {
	...
	public void getEmployee() {
		...
		response = httpRequest.request(Method.GET, baseURI + "/employee/empId");
	}
	...
	public void checkRespose() {
		...
		//Assert.assertTrue(resposeBody.contains("abhay"));
...
//	      System.out.println(data);
	...
	public void checkContentLength() {
		...
		Assert.assertTrue(Integer.parseInt(contentLength) > 1);
